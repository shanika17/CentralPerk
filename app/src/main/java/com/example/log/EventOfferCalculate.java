...
public class EventOfferCalculate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_event_one = findViewById(R.id.event_input1);
        et_event_two = findViewById(R.id.event_input2);
        et_event_three = findViewById(R.id.event_input3);
        et_event_four = findViewById(R.id.event_input4);
